...
app.get('/search.usedcar', (request, response) => {
    ...
    let result = `
        ...
        <table style="border-collapse: collapse; border: 2px solid blue;">
            <tr style="background : yellow;">
                ...
                <th style="border: 1px solid black; text-align : center; padding : 2px 5px">등록번호</th>
                <th style="border: 1px solid black; text-align : center; padding : 2px 5px">차종</th>
                <th style="border: 1px solid black; text-align : center; padding : 2px 5px">연식</th>
                <th style="border: 1px solid black; text-align : center; padding : 2px 5px">주행거리</th>
                <th style="border: 1px solid black; text-align : center; padding : 2px 5px">색상</th>
                <th style="border: 1px solid black; text-align : center; padding : 2px 5px">가격</th>
            </tr>
    `;
    ...
    result += mycar.map((car, index) => `
        <tr>
            ...
            <td style="border: 1px solid black; text-align : center; padding : 2px 5px">${car.id}</td>
            <td style="border: 1px solid black; text-align : center; padding : 2px 5px">${car.model}</td>
            <td style="border: 1px solid black; text-align : center; padding : 2px 5px">${car.year}년</td>
            <td style="border: 1px solid black; text-align : right; padding : 2px 5px">${car.distance}km</td>
            <td style="border: 1px solid black; text-align : center; padding : 2px 5px">${car.color}</td>
            <td style="border: 1px solid black; text-align : right; padding : 2px 5px">${car.price}만원</td>
        </tr>
    `).join('');
